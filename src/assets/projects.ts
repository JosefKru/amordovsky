...
export const projects = [
  {
    ...
    meta: {
      ...
      meta: [
        [
          "Гипотезы",
          "Перед началом работы я провел детальный анализ пользовательских сценариев, изучили ключевые барьеры, с которыми сталкиваются покупатели, и собрал обратную связь через интервью. Это позволило глубже понять потребности различных групп клиентов — от частных покупателей, которые делают выбор на основе удобства и доступности, до профессионалов, для которых важны детализированные характеристики товаров и гибкость поиска.</br>На основе полученных данных была разработана стратегия редизайна, направленная на повышение удобства поиска, оптимизацию структуры каталога и внедрение⠀⠀⠀⠀ инструментов персонализации.",
        ],
      ],
      features: [
        [
        ...
        [
          ...
          [
            [
              "Продуктовые метрики",
              "После изменений в поиске пользователи стали быстрее находить нужные товары, что отразилось на показателях вовлеченности. Время, затраченное на поиск, уменьшилось,⠀⠀⠀ а доля успешных запросов увеличилась. Количество пользователей, покидающих сайт сразу после попытки⠀⠀⠀ поиска, снизилось, что говорит о том, что система стала⠀⠀⠀ лучше подбирать релевантные товары.</br>Конверсия из поиска в просмотр карточек товаров⠀⠀ значительно выросла, так как пользователи стали чаще⠀⠀ кликать на предложенные результаты. Дополнительно увеличилось среднее число товаров, просматриваемых⠀⠀⠀ после поиска, что говорит о большем доверии к выдаче⠀ удобстве навигации по результатам.",
            ],
          ],
          [
            "HEAD",
